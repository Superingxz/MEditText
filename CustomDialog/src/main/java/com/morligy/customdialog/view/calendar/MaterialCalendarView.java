...
public class MaterialCalendarView extends ViewGroup {
    ...
    private int accentColor = Color.parseColor("#3baeda");
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
             ...
             * 左右按钮 	颜色
             */
            setArrowColor(a.getColor(R.styleable.MaterialCalendarView_mcv_arrowColor, arrowColor));
            ...
            if (leftMask == null) {
                leftMask = getResources().getDrawable(R.drawable.ic_arrow_one_pressed);
            }
            ...
            if (rightMask == null) {
                rightMask = getResources().getDrawable(R.drawable.ic_arrow_one_nomal);
            }
             ...
             * 选择日 	背景色
             */
            setSelectionColor(a.getColor(R.styleable.MaterialCalendarView_mcv_selectionColor, accentColor));
            ...
            setShowOtherDates(a.getInteger(R.styleable.MaterialCalendarView_mcv_showOtherDates,
            		SHOW_DEFAULTS));
    ...
    private void setupChildren() {
        ...
        topbar.setBackgroundColor(Color.parseColor("#46aaf8"));
        ...
        buttonPast.setImageResource(R.drawable.ic_mcv_action_previous);
        topbar.addView(buttonPast, new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, 1));

        title.setGravity(Gravity.CENTER);
        topbar.addView(title, new LinearLayout.LayoutParams(0, LayoutParams.MATCH_PARENT, MonthView.DEFAULT_DAYS_IN_WEEK - 2));
        
        buttonFuture.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        buttonFuture.setImageResource(R.drawable.ic_mcv_action_next);
...
//        }
    ...
    protected void onMeasure(final int widthMeasureSpec, final int heightMeasureSpec) {
        ...
        //如果 整个View宽度 小于屏幕宽度 则 为屏幕宽度
        if(measuredWidth < specWidthSize){
        ...
        for (int i = 0; i < count; i++) {
            ...
            int childWidthMeasureSpec = MeasureSpec.makeMeasureSpec(
            		measuredWidth,		//MonthView.DEFAULT_DAYS_IN_WEEK * measureTileSize,
                    MeasureSpec.EXACTLY
            );
            
            int childHeightMeasureSpec = 0;
            if(i == 0 && getTopbarVisible()){//设置title 高度
