...
public abstract class BaseDateAndTimeDialog<T extends BaseDateAndTimeDialog<T>> extends BaseDialog 
    ...
    protected OnBtnSelectDateAndTimeClickL onBtnLeftClickL;
    /** right btn click listener(右按钮接口) */
    protected OnBtnSelectDateAndTimeClickL onBtnRightClickL;
     ...
     * @param context
     */
    public BaseDateAndTimeDialog(Context context) {
        super(context);
        widthScale(0.85f);
        ...
        tv_btn_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	if (onBtnLeftClickL != null) {
            		onBtnLeftClickL.OnBtnSelectDateAndTimeClick(0, 0, 0, 0, 0);
                	dismiss();
                } else {
                    dismiss();
                }
        ...
        tv_btn_right.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
            	if (onBtnRightClickL != null) {
                	...
                	onBtnRightClickL.OnBtnSelectDateAndTimeClick(dp_picker.getYear(), dp_picker.getMonth(), 
                			dp_picker.getDayOfMonth(), tp_picker.getCurrentHour(), minute_s);
     ...
     */
    public void setOnBtnClickL(OnBtnSelectDateAndTimeClickL... onBtnClickLs) {
