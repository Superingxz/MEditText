...
public class LoadingProgressView extends View {
    ...
    private List<LoadingProgressViewListener> listeners;
    ...
    {
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.LoadingProgressViewStyle, defStyle, 0);

        // Initialize attributes from styleable attributes
        currentProgress = a.getFloat(R.styleable.LoadingProgressViewStyle_lpvs_progress, 0);
        maxProgress = a.getFloat(R.styleable.LoadingProgressViewStyle_lpvs_maxProgress, 100);
        thickness = a.getDimensionPixelSize(R.styleable.LoadingProgressViewStyle_lpvs_thickness, 4);//4dp
        isIndeterminate = a.getBoolean(R.styleable.LoadingProgressViewStyle_lpvs_indeterminate, false);
        autostartAnimation = a.getBoolean(R.styleable.LoadingProgressViewStyle_lpvs_animAutostart, false);

        color = a.getColor(R.styleable.LoadingProgressViewStyle_lpvs_color, Color.parseColor("#2196F3"));
...
//        if (a.hasValue(R.styleable.LoadingProgressViewStyle_lpvs_color)) {
//            color = a.getColor(R.styleable.LoadingProgressViewStyle_lpvs_color, Color.parseColor("#2196F3"));
//        }
...
//        }
        ...
        animDuration = a.getInteger(R.styleable.LoadingProgressViewStyle_lpvs_animDuration, 4000);
        animSwoopDuration = a.getInteger(R.styleable.LoadingProgressViewStyle_lpvs_animSwoopDuration, 5000);
        animSyncDuration = a.getInteger(R.styleable.LoadingProgressViewStyle_lpvs_animSyncDuration, 500);
        animSteps = a.getInteger(R.styleable.LoadingProgressViewStyle_lpvs_animSteps, 3);
    ...
    public void setIndeterminate(boolean isIndeterminate) {
        ...
        if(old != isIndeterminate) {
            for(LoadingProgressViewListener listener : listeners) {
     ...
     */
    public void addListener(LoadingProgressViewListener listener) {
        if(listener != null)
     ...
     */
    public void removeListener(LoadingProgressViewListener listener) {
