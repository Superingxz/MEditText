...
import com.morligy.customdialog.view.dialog.base.BaseDateAndTimeDialog;
import com.morligy.customdialog.view.dialog.utils.CornerUtils;


public class DateAndTimePickerDialog extends BaseDateAndTimeDialog<DateAndTimePickerDialog> {
    ...
    public View onCreateView() {
        ...
        tp_picker.setLayoutParams(new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
    			LinearLayout.LayoutParams.WRAP_CONTENT));
        ll_container.addView(tp_picker);
    ...
    /** set style(设置style) */
    public DateAndTimePickerDialog style(int style) {
        this.style = style;
        return this;
    }

    /** set title underline color(设置标题下划线颜色) */
    public DateAndTimePickerDialog titleLineColor(int titleLineColor) {
        this.titleLineColor = titleLineColor;
        return this;
    }

    /** set title underline height(设置标题下划线高度) */
    public DateAndTimePickerDialog titleLineHeight(float titleLineHeight_DP) {
        this.titleLineHeight_DP = titleLineHeight_DP;
        return this;
    }

    /** set divider color between btns(设置btn分割线的颜色) */
    public DateAndTimePickerDialog dividerColor(int dividerColor) {
