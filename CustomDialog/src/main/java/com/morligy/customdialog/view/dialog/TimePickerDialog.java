...
import com.morligy.customdialog.view.dialog.base.BaseTimeDialog;
 ...
 */
public class TimePickerDialog extends BaseTimeDialog<TimePickerDialog> {
	/** title underline */
    ...
    public void setUiBeforShow() {
        ...
        tp_picker.setPadding(dp2px(0), dp2px(10), dp2px(0), dp2px(10));
    ...
    /** set style(设置style) */
    public TimePickerDialog style(int style) {
        this.style = style;
        return this;
    }

    /** set title underline color(设置标题下划线颜色) */
    public TimePickerDialog titleLineColor(int titleLineColor) {
        this.titleLineColor = titleLineColor;
        return this;
    }

    /** set title underline height(设置标题下划线高度) */
    public TimePickerDialog titleLineHeight(float titleLineHeight_DP) {
        this.titleLineHeight_DP = titleLineHeight_DP;
        return this;
    }

    /** set divider color between btns(设置btn分割线的颜色) */
    public TimePickerDialog dividerColor(int dividerColor) {
